                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form thêm quản trị viên</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="../function/them-admin.php" method="post">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            <label for="first-name-icon">Họ tên quản trị viên</label>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            <label for="email-id-icon">Mật khẩu</label>
                                                            <div class="position-relative">
                                                                <input type="password" class="form-control" id="email-id-icon" name="matkhau">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-key"></i>
                                                                </div>
                                                            </div>
